    ...
    <div className="space-y-8 pb-20">
      ...
      <section className="grid gap-6 lg:grid-cols-[1fr_300px] lg:items-stretch">
        <Card className="bg-nexo-surface p-8 duration-200 ease-out">
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-display font-bold text-white mb-3">{mockAsset.title}</h1>
              <p className="text-[15px] text-text-secondary leading-relaxed max-w-2xl">{mockAsset.heroDescription}</p>
            </div>
          </div>

          <div className="mt-8 flex gap-4 rounded-lg border border-white/5 border-l-2 border-l-nexo-aqua/60 bg-nexo-bg/40 p-4">
            <p className="text-sm text-text-secondary">{mockAsset.heroNote}</p>
          </div>
        </Card>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="flex flex-col">
          ...
          <Card className="flex-1 bg-nexo-surface p-5 duration-200 ease-out">
            ...
            <div className="space-y-3">
              {mockAsset.structurePaths.map((item) => (
        ...
        <div className="flex flex-col">
          ...
          <Card className="flex-1 bg-nexo-surface p-5 duration-200 ease-out">
            ...
            <div className="space-y-3">
              {mockAsset.relations.map((relation) => (
      ...
      <section>
        ...
        <Card className="p-6 duration-200 ease-out">
          <p className="text-[15px] leading-7 text-text-secondary">{mockAsset.longDescription}</p>
        </Card>
      </section>
    </div>
  );
