  ...
  return (
    <>
      <header className="flex flex-col gap-3">
        <span className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-300/70">MVP Landing</span>
        <h1 className="font-[var(--font-space-grotesk)] text-4xl font-semibold leading-tight sm:text-5xl">Nexonoma</h1>
        <p className="max-w-3xl text-lg font-medium text-slate-200/85">Visuelle Wissensnavigation für Entwickler und Architekten</p>
      </header>

      <section className="max-w-3xl space-y-3 text-base leading-relaxed text-slate-200/85 sm:text-lg">
        <p>Nexonoma verbindet Wissensbereiche und Wissensbausteine zu einer interaktiven, mehrdimensionalen Navigationsoberfläche.</p>
      </section>
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-r from-[#131C2E] via-[#0F182A] to-[#1F2A40] p-6 sm:p-8">
        ...
        <div className="relative flex flex-col gap-2">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-200/75">Intro</p>
          <p className="text-base text-slate-200/85 sm:text-lg">
            Placeholder für ein zukünftiges Visual: eine marinefarbene Fläche mit sanftem Glow, die das Navigationskonzept andeutet.
          </p>
        </div>
      </section>
    </>
