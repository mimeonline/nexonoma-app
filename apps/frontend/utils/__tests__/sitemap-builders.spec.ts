...
describe("sitemap builders", () => {
  it("builds sitemap pages with the exact static list", () => {
    ...
    expect(entries.map((entry) => entry.loc)).toEqual([
      ...
      "https://app.nexonoma.de/de/content",
      "https://app.nexonoma.de/en/content",
      "https://app.nexonoma.de/de/360",
      "https://app.nexonoma.de/en/360",
      "https://app.nexonoma.de/de/grid",
      "https://app.nexonoma.de/en/grid",
      "https://app.nexonoma.de/de/matrix",
      "https://app.nexonoma.de/en/matrix",
